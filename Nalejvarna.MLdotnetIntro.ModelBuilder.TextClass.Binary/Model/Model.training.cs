...
namespace Nalejvarna_MLdotnetIntro_ModelBuilder_TextClass_Binary
{
    public partial class Model
    {
        public const string RetrainFilePath =  @"C:\Users\david\source\repos\Nalejvarna\Nalejvarna.MLdotnetIntro\Nalejvarna.MLdotnetIntro.Shared\Data\csfd_bin.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.836575F,L2Regularization=0.03367424F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}), labelColumnName:@"col1"))      
